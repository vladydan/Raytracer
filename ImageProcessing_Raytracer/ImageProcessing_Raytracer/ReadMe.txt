========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet ImageProcessing_Raytracer
========================================================================

AppWizard a créé cette application ImageProcessing_Raytracer pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application ImageProcessing_Raytracer.


ImageProcessing_Raytracer.vcxproj
...
ImageProcessing_Raytracer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) ImageProcessing_Raytracer.pch et un fichier de type précompilé nommé StdAfx.obj.
